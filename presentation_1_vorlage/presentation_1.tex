...
\definecolor{UBCblue}{rgb}{0.6745098039215686, 0.02352941176470588, 0.2039215686274510} % UBC Blue (primary)
\definecolor{UBCgrey}{rgb}{0.8117647058823529, 0.8117647058823529, 0.8117647058823529} % UBC Grey (secondary)
...
\title[4.1 Partizipative Methoden]{4.1 Anwendung partizipativer Methoden in sozialökologischer Forschung} % The short title appears at the bottom of every slide, the full title is only on the title page

\author{Julian Unland, Martin ben Ahmed} % Your name
...
\medskip
\textit{juunland@uos.de} % Your email address
\textit{mbenahmed@uos.de} % Your email address
}
