...
\begin{document}
	...
	\begin{titlepage}
		\begin{center}
			...
			AUSARBEITUNG \\[1cm]
			zum Seminar \\[1cm]
			\textbf{Beispielseminar} \\[1.5cm]    % Seminartitel eintragen 
			im Sommersemester 2017 \\[1.5cm]   % Semester / Datum eintragen
			Thema: \\[0.5cm]
			\textbf{Mein Beispielthema} \\[2cm]        % Titel des eigenen Seminarthemas eintragen
			Erstellt am \today
		\end{center}
		\vfill
		\begin{flushleft}
			Vorgelegt von: 
			\hfill \parbox{60mm}{Arthur Dent und Ford Prefect} \\  % Eigene Daten einsetzen
			\hfill \parbox{60mm}{123456} \\
			\hfill \parbox{60mm}{Albrechtstraße 1} \\
			\hfill \parbox{60mm}{49074 Osnabrück} \\
			\hfill \parbox{60mm}{not.available@uos.de}
		\end{flushleft}
	\end{titlepage}
	%%% end title page
